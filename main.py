...
# The following was used to help troubleshoot when I was getting an error
...
async def get_root():
    """ Say hello!"""
    return {"greeting": "Hello, Bonjour, Hola, Guten Tag, Hei! Welcome to the API!"}


# Create a POST on a different path that does model inference
@app.post("/data/")
async def post_inference(data: Data):
    # The following if was used to help troubleshoot and find an error
    if model is None or encoder is None:
        raise Exception("Model or encoder not loaded properly.")
